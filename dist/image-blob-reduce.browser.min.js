...
//# sourceURL=pica-inline-worker.js`,Me=1;typeof navigator<`u`&&(Me=Math.min(navigator.hardwareConcurrency||1,4));var Ne={tile:1024,concurrency:Me,features:[`js`,`wasm`,`ww`],idle:2e3},G={filter:`mks2013`,unsharpAmount:0,unsharpRadius:0,unsharpThreshold:0},Pe=class{constructor(e){M(this,`options`,void 0),M(this,`__limit`,void 0),M(this,`resize_features`,void 0),M(this,`__workersPool`,void 0),M(this,`capabilities`,void 0),M(this,`__requested_features`,void 0),M(this,`__mathlib`,void 0),M(this,`__initPromise`,void 0),this.options=Object.assign({},Ne,e||{}),(this.options.features.indexOf(`ww`)>=0||this.options.features.indexOf(`all`)>=0)&&this.options.workerURL,this.__limit=fe(this.options.concurrency),this.resize_features={js:!1,wasm:!1,cib:!1,ww:!1},this.__workersPool=null,this.capabilities={worker:!1,ww_offscreen_canvas:!1,canvas:!1,offscreen_canvas:!1,may_be_worker:!1,create_image_bitmap:!1,safari_put_image_data_fix:!1,bug_canvas_orientation_region:!0,bug_image_bitmap_orientation_region:!0,cib_resize:!1},this.__requested_features=[],this.__mathlib=null}init(){return this.__initPromise||(this.__initPromise=this.__init()),this.__initPromise}__init(){var e=this;return W(function*(){let t=e.options.features.slice();t.indexOf(`all`)>=0&&(t=[`cib`,`wasm`,`js`,`ww`]),e.__requested_features=t,e.__mathlib=new ie(t);let n=yield ke();if(Object.assign(e.capabilities,n),e.capabilities.cib_resize&&t.indexOf(`cib`)>=0&&(e.resize_features.cib=!0),e.capabilities.may_be_worker&&t.indexOf(`ww`)>=0&&je&&(e.__workersPool=new le(()=>e.__createWorkerSlot(),e.options.idle)),e.__workersPool)try{let t=yield e.__invokeWorker(`get_supported_features`),n=t&&t.data;n&&(e.capabilities.worker=!0,e.resize_features.ww=!0,e.capabilities.ww_offscreen_canvas=!!n.offscreen_canvas)}catch(e){}let r=yield e.__mathlib.init();return Object.assign(e.resize_features,r.features),e})()}createCanvas(e,t,n){if(n&&this.capabilities.offscreen_canvas)return new OffscreenCanvas(e,t);if(this.capabilities.canvas){let n=document.createElement(`canvas`);return n.width=e,n.height=t,n}if(this.capabilities.ww_offscreen_canvas)return new OffscreenCanvas(e,t);throw Error(`Pica: cannot create canvas`)}__createWorkerSlot(){if(this.options.workerURL){let e=new Worker(String(this.options.workerURL));return{value:e,destroy(){e.terminate()}}}{let e=window.URL.createObjectURL(new Blob([je],{type:`text/javascript`})),t=new Worker(e);return{value:t,destroy(){if(t.terminate(),typeof window<`u`){var n,r;(n=window.URL)==null||(r=n.revokeObjectURL)==null||r.call(n,e)}}}}throw Error(`Pica: no worker source available`)}__invokeWorker(e,t,n,r){return new Promise((i,a)=>{let o=this.__workersPool.acquire();r&&r.cancelToken&&r.cancelToken.catch(e=>a(e)),o.value.onmessage=e=>{o.release(),e.data.err?a(e.data.err):i(e.data)},o.value.postMessage(Object.assign({method:e},t||{}),n||[])})}__invokeResize(e,t){var n=this;return W(function*(){if(yield Promise.resolve(),!n.resize_features.ww){if(e.kind!==`array`)throw Error(`Pica: resize tile data is missing`);let t={src:e.src,width:e.width,height:e.height,toWidth:e.toWidth,toHeight:e.toHeight,scaleX:e.scaleX,scaleY:e.scaleY,offsetX:e.offsetX,offsetY:e.offsetY,filter:e.filter,unsharpAmount:e.unsharpAmount,unsharpRadius:e.unsharpRadius,unsharpThreshold:e.unsharpThreshold};return{kind:`array`,data:n.__mathlib.resizeAndUnsharp(t)}}let r=[];return e.kind===`array`?r.push(e.src.buffer):r.push(e.src),n.__invokeWorker(`resize`,{job:e,features:n.__requested_features},r,t)})()}__extractTileData(e,t,n,r){if(this.resize_features.ww&&this.capabilities.ww_offscreen_canvas){this.debug(`Create tile imageBitmap`);let i=this.createCanvas(e.width,e.height,{preferOffscreen:!0});if(i.getContext(`2d`).drawImage(n.srcImageBitmap||t,e.x,e.y,e.width,e.height,0,0,e.width,e.height),!(`transferToImageBitmap`in i))throw Error(`Pica: offscreen canvas is not available for worker transfer`);return Object.assign({},r,{kind:`bitmap`,src:i.transferToImageBitmap()})}if(ue(t))return n.srcCtx||(n.srcCtx=t.getContext(`2d`)),this.debug(`Get tile pixel data`),Object.assign({},r,{kind:`array`,src:n.srcCtx.getImageData(e.x,e.y,e.width,e.height).data});this.debug(`Draw tile imageBitmap/image to temporary canvas`);let i=this.createCanvas(e.width,e.height,{preferOffscreen:!0}),a=i.getContext(`2d`);a.globalCompositeOperation=`copy`,a.drawImage(n.srcImageBitmap||t,e.x,e.y,e.width,e.height,0,0,e.width,e.height),this.debug(`Get tile pixel data`);let o=a.getImageData(0,0,e.width,e.height).data;return i.width=i.height=0,Object.assign({},r,{kind:`array`,src:o})}__landTileData(e,t,n){if(t.kind===`bitmap`)return n.toCtx.drawImage(t.data,e.toX,e.toY),t.data.close(),null;this.debug(`Draw tile`);let r=n.toCtx.createImageData(e.toWidth,e.toHeight);return r.data.set(t.data),this.capabilities.safari_put_image_data_fix?n.toCtx.putImageData(r,e.toX,e.toY,e.toInnerX-e.toX,e.toInnerY-e.toY,e.toInnerWidth+1e-5,e.toInnerHeight+1e-5):n.toCtx.putImageData(r,e.toX,e.toY,e.toInnerX-e.toX,e.toInnerY-e.toY,e.toInnerWidth,e.toInnerHeight),null}__tileAndResize(e,t,n,r){var i=this;return W(function*(){let a={srcCtx:null,srcImageBitmap:null,isImageBitmapReused:!1,toCtx:null},o=t=>i.__limit(W(function*(){if(r.canceled)return r.cancelToken;let o={width:t.width,height:t.height,toWidth:t.toWidth,toHeight:t.toHeight,scaleX:t.scaleX,scaleY:t.scaleY,offsetX:t.offsetX,offsetY:t.offsetY,filter:n.filter,unsharpAmount:n.unsharpAmount,unsharpRadius:n.unsharpRadius,unsharpThreshold:n.unsharpThreshold};i.debug(`Invoke resize math`);let s=yield i.__extractTileData(t,e,a,o);i.debug(`Invoke resize math`);let c=yield i.__invokeResize(s,r);return r.canceled?r.cancelToken:i.__landTileData(t,c,a)}));if(yield Promise.resolve(),a.toCtx=t.getContext(`2d`),!ue(e))if(de(e))a.srcImageBitmap=e,a.isImageBitmapReused=!0;else if(F(e)){if(i.capabilities.create_image_bitmap){i.debug(`Decode image via createImageBitmap`);try{a.srcImageBitmap=yield createImageBitmap(e)}catch(e){}}}else throw Error(`Pica: ".from" should be Image, Canvas or ImageBitmap`);if(r.canceled)return r.cancelToken;i.debug(`Calculate tiles`);let s=Se({width:n.width,height:n.height,srcTileSize:i.options.tile,toWidth:n.toWidth,toHeight:n.toHeight,destTileBorder:Math.ceil(Math.max(3,2.5*n.unsharpRadius|0))}).map(e=>o(e));function c(e){e.srcImageBitmap&&(e.isImageBitmapReused||e.srcImageBitmap.close(),e.srcImageBitmap=null)}i.debug(`Process tiles`);try{return yield Promise.all(s),i.debug(`Finished!`),c(a),t}catch(e){throw c(a),e}})()}__planStagesAndResize(e,t,n,r){var i=this;return W(function*(){let a=e,o=n.width,s=n.height,c=ye(n.width,n.height,n.toWidth,n.toHeight,i.options.tile);for(;c.length>0;){if(r.canceled)return r.cancelToken;let[l,u]=c.shift(),d=c.length===0,f;f=d||!he(n.filter)?n.filter:n.filter===`box`?`box`:`hamming`;let p=N(N({},n),{},{filter:f,width:o,height:s,toWidth:l,toHeight:u}),m=d?t:i.createCanvas(l,u,{preferOffscreen:!0}),h=a===e?void 0:a;try{yield i.__tileAndResize(a,m,p,r)}finally{h&&(h.width=h.height=0)}a=m,o=l,s=u}return t})()}__resizeViaCreateImageBitmap(e,t,n,r){var i=this;return W(function*(){var a;let o=t.getContext(`2d`);i.debug(`Resize via createImageBitmap()`);let s=yield createImageBitmap(e,{resizeWidth:n.toWidth,resizeHeight:n.toHeight,resizeQuality:pe((a=ge(n.filter))==null?3:a)});if(r.canceled)return r.cancelToken;if(!n.unsharpAmount)return o.drawImage(s,0,0),s.close(),o=null,i.debug(`Finished!`),t;i.debug(`Unsharp result`);let c=i.createCanvas(n.toWidth,n.toHeight),l=c.getContext(`2d`);l.drawImage(s,0,0),s.close();let u=l.getImageData(0,0,n.toWidth,n.toHeight);return i.__mathlib.unsharp_mask(u.data,n.toWidth,n.toHeight,n.unsharpAmount,n.unsharpRadius,n.unsharpThreshold),o.putImageData(u,0,0),c.width=c.height=0,u=l=c=o=null,i.debug(`Finished!`),t})()}resize(e,t,n){var r=this;return W(function*(){r.debug(`Start resize...`);let i={};n&&Object.assign(i,n);let a=i.filter||G.filter;if(Object.prototype.hasOwnProperty.call(i,`quality`)){let e=i.quality;if(typeof e!=`number`||e<0||e>3)throw Error(`Pica: .quality should be [0..3], got ${e}`);a=me(e)}let o={filter:a,unsharpAmount:i.unsharpAmount||G.unsharpAmount,unsharpRadius:i.unsharpRadius||G.unsharpRadius,unsharpThreshold:i.unsharpThreshold||G.unsharpThreshold,width:F(e)?e.naturalWidth:e.width,height:F(e)?e.naturalHeight:e.height,toWidth:t.width,toHeight:t.height};if(o.unsharpRadius>2&&(o.unsharpRadius=2),t.width===0||t.height===0)return Promise.reject(Error(`Invalid output size: ${t.width}x${t.height}`));let s={cancelToken:i.cancelToken,canceled:!1};if(s.cancelToken&&(s.cancelToken=s.cancelToken.then(e=>{throw s.canceled=!0,e},e=>{throw s.canceled=!0,e})),yield r.init(),s.canceled)return s.cancelToken;if(r.capabilities.bug_image_bitmap_orientation_region&&(F(e)||de(e))){let t=r.createCanvas(o.width,o.height);t.getContext(`2d`).drawImage(e,0,0),e=t}if(r.resize_features.cib){if(he(o.filter))return r.__resizeViaCreateImageBitmap(e,t,o,s);r.debug(`cib is enabled, but not supports provided filter, fallback to manual math`)}if(!r.capabilities.canvas&&!r.capabilities.offscreen_canvas){let e=Error(`Pica: cannot use getImageData on canvas, make sure fingerprinting protection isn't enabled`);throw e.code=`ERR_GET_IMAGE_DATA`,e}return r.__planStagesAndResize(e,t,o,s)})()}resizeBuffer(e){var t=this;return W(function*(){let n=Object.assign({},G,e);if(Object.prototype.hasOwnProperty.call(n,`quality`)){let e=n.quality;if(typeof e!=`number`||e<0||e>3)throw Error(`Pica: .quality should be [0..3], got ${e}`);n.filter=me(e)}if(yield t.init(),!t.__mathlib)throw Error(`Pica: math library is not initialized`);let r={src:n.src,width:n.width,height:n.height,toWidth:n.toWidth,toHeight:n.toHeight,dest:n.dest,scaleX:n.toWidth/n.width,scaleY:n.toHeight/n.height,offsetX:0,offsetY:0,filter:n.filter,unsharpAmount:n.unsharpAmount,unsharpRadius:n.unsharpRadius,unsharpThreshold:n.unsharpThreshold};return t.__mathlib.resizeAndUnsharp(r)})()}toBlob(e,t,n){return W(function*(){if(t=t||`image/png`,`toBlob`in e&&e.toBlob)return new Promise(r=>{e.toBlob(e=>r(e),t,n)});if(`convertToBlob`in e&&e.convertToBlob)return e.convertToBlob({type:t,quality:n});let r=atob(e.toDataURL(t,n).split(`,`)[1]),i=r.length,a=new Uint8Array(i);for(let e=0;e<i;e++)a[e]=r.charCodeAt(e);return new Blob([a],{type:t})})()}debug(...e){}};function Fe(e){return new Pe(e)}function K(e){"@babel/helpers - typeof";return K=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},K(e)}function Ie(e,t){if(K(e)!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t||`default`);if(K(r)!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}function Le(e){var t=Ie(e,`string`);return K(t)==`symbol`?t:t+``}function q(e,t,n){return(t=Le(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var Re=t({is_jpeg:()=>X,jpeg_add_comment:()=>Ke,jpeg_exif_tags_each:()=>We,jpeg_exif_tags_filter:()=>Ge,jpeg_segments_each:()=>Z,jpeg_segments_filter:()=>Ue});function J(e,t){let n=Error(e);return n.code=t,n}function ze(e){let t=e.toString(16).toUpperCase();for(let e=2-t.length;e>0;e--)t=`0`+t;return`0x`+t}function Be(e){try{return unescape(encodeURIComponent(e))}catch(t){return e}}function Ve(e){try{return decodeURIComponent(escape(e))}catch(t){return e}}function Y(e){return Object.prototype.toString.call(e)===`[object Uint8Array]`}var He=class{constructor(e,t,n){q(this,`input`,void 0),q(this,`start`,void 0),q(this,`big_endian`,void 0),q(this,`aborted`,!1),q(this,`ifds_to_read`,[]),q(this,`output`,new Uint8Array),this.input=e.subarray(t,n),this.start=t;let r=String.fromCharCode.apply(null,this.input.subarray(0,4));if(r!==`II*\0`&&r!==`MM\0*`)throw J(`invalid TIFF signature`,`EBADDATA`);this.big_endian=r[0]===`M`}each(e){this.aborted=!1;let t=this.read_uint32(4);for(this.ifds_to_read=[{id:0,offset:t}];this.ifds_to_read.length>0&&!this.aborted;){let t=this.ifds_to_read.shift();!t||!t.offset||this.scan_ifd(t.id,t.offset,e)}}filter(e){let t={};t.ifd0={id:0,entries:[]},this.each(function(n){e(n)===!1&&!n.is_subifd_link||n.is_subifd_link&&n.count!==1&&n.format!==4||(t[`ifd`+n.ifd]||(t[`ifd`+n.ifd]={id:n.ifd,entries:[]}),t[`ifd`+n.ifd].entries.push(n))}),delete t.ifd1;let n=8;Object.keys(t).forEach(function(e){n+=2,t[e].entries.forEach(function(e){n+=12+(e.data_length>4?Math.ceil(e.data_length/2)*2:0)}),n+=4}),this.output=new Uint8Array(n),this.output[0]=this.output[1]=(this.big_endian?`M`:`I`).charCodeAt(0),this.write_uint16(2,42);let r=8;if(this.write_uint32(4,r),Object.keys(t).forEach(e=>{t[e].written_offset=r;let n=r,i=n+2+t[e].entries.length*12+4;r=i,this.write_uint16(n,t[e].entries.length),t[e].entries.sort(function(e,t){return e.tag-t.tag}).forEach((e,i)=>{let a=n+2+i*12;this.write_uint16(a,e.tag),this.write_uint16(a+2,e.format),this.write_uint32(a+4,e.count),e.is_subifd_link?t[`ifd`+e.tag]&&(t[`ifd`+e.tag].link_offset=a+8):e.data_length<=4?this.output.set(this.input.subarray(e.data_offset-this.start,e.data_offset-this.start+4),a+8):(this.write_uint32(a+8,r),this.output.set(this.input.subarray(e.data_offset-this.start,e.data_offset-this.start+e.data_length),r),r+=Math.ceil(e.data_length/2)*2)});let a=t[`ifd`+(t[e].id+1)];a&&(a.link_offset=i-4)}),Object.keys(t).forEach(e=>{t[e].written_offset&&t[e].link_offset&&this.write_uint32(t[e].link_offset,t[e].written_offset)}),this.output.length!==r)throw J(`internal error: incorrect buffer size allocated`);return this.output}read_uint16(e){let t=this.input;if(e+2>t.length)throw J(`unexpected EOF`,`EBADDATA`);return this.big_endian?t[e]*256+t[e+1]:t[e]+t[e+1]*256}read_uint32(e){let t=this.input;if(e+4>t.length)throw J(`unexpected EOF`,`EBADDATA`);return this.big_endian?t[e]*16777216+t[e+1]*65536+t[e+2]*256+t[e+3]:t[e]+t[e+1]*256+t[e+2]*65536+t[e+3]*16777216}write_uint16(e,t){let n=this.output;this.big_endian?(n[e]=t>>>8&255,n[e+1]=t&255):(n[e]=t&255,n[e+1]=t>>>8&255)}write_uint32(e,t){let n=this.output;this.big_endian?(n[e]=t>>>24&255,n[e+1]=t>>>16&255,n[e+2]=t>>>8&255,n[e+3]=t&255):(n[e]=t&255,n[e+1]=t>>>8&255,n[e+2]=t>>>16&255,n[e+3]=t>>>24&255)}is_subifd_link(e,t){return e===0&&t===34665||e===0&&t===34853||e===34665&&t===40965}exif_format_length(e){switch(e){case 1:case 2:case 6:case 7:return 1;case 3:case 8:return 2;case 4:case 9:case 11:return 4;case 5:case 10:case 12:return 8;default:return 0}}exif_format_read(e,t){let n;switch(e){case 1:case 2:return n=this.input[t],n;case 6:return n=this.input[t],n|(n&128)*33554430;case 3:return n=this.read_uint16(t),n;case 8:return n=this.read_uint16(t),n|(n&32768)*131070;case 4:return n=this.read_uint32(t),n;case 9:return n=this.read_uint32(t),n|0;case 5:case 10:case 11:case 12:return null;case 7:return null;default:return null}}scan_ifd(e,t,n){let r=this.read_uint16(t);t+=2;for(let i=0;i<r;i++){let r=this.read_uint16(t),i=this.read_uint16(t+2),a=this.read_uint32(t+4),o=this.exif_format_length(i),s=a*o,c=s<=4?t+8:this.read_uint32(t+8),l=!1;if(c+s>this.input.length)throw J(`unexpected EOF`,`EBADDATA`);let u=[],d=c;for(let e=0;e<a;e++,d+=o){let e=this.exif_format_read(i,d);if(e===null){u=null;break}u.push(e)}if(Array.isArray(u)&&i===2){try{u=Ve(String.fromCharCode.apply(null,u))}catch(e){u=null}u&&u[u.length-1]===`\0`&&(u=u.slice(0,-1))}if(this.is_subifd_link(e,r)&&Array.isArray(u)&&Number.isInteger(u[0])&&u[0]>0&&(this.ifds_to_read.push({id:r,offset:u[0]}),l=!0),n({is_big_endian:this.big_endian,ifd:e,tag:r,format:i,count:a,entry_offset:t+this.start,data_length:s,data_offset:c+this.start,value:u,is_subifd_link:l})===!1){this.aborted=!0;return}t+=12}e===0&&this.ifds_to_read.push({id:1,offset:this.read_uint32(t)})}};function X(e){return e.length>=4&&e[0]===255&&e[1]===216&&e[2]===255}function Z(e,t){if(!Y(e))throw J(`Invalid argument (jpeg_bin), Uint8Array expected`,`EINVAL`);if(typeof t!=`function`)throw J(`Invalid argument (on_segment), Function expected`,`EINVAL`);if(!X(e))throw J(`Unknown file format`,`ENOTJPEG`);let n=0,r=!1,i=e.length;for(;;){let a,o;if(n+1>=i)throw J(`Unexpected EOF`,`EBADDATA`);let s=e[n],c=e[n+1];if(s===255&&c===255)a=255,o=1;else if(s===255&&c!==0){if(a=c,o=2,!(a>=208&&a<=217||a===1)){if(n+3>=i)throw J(`Unexpected EOF`,`EBADDATA`);if(o+=e[n+2]*256+e[n+3],o<2)throw J(`Invalid segment length`,`EBADDATA`);if(n+o-1>=i)throw J(`Unexpected EOF`,`EBADDATA`)}r&&(a>=208&&a<=215||(r=!1)),a===218&&(r=!0)}else if(r)for(let t=n+1;;t++){if(t>=i)throw J(`Unexpected EOF`,`EBADDATA`);if(e[t]===255){if(t+1>=i)throw J(`Unexpected EOF`,`EBADDATA`);if(e[t+1]!==0){a=0,o=t-n;break}}}else throw J(`Unexpected byte at segment start: `+ze(s)+` (offset `+ze(n)+`)`,`EBADDATA`);if(t({code:a,offset:n,length:o})===!1||a===217)break;n+=o}}function Ue(e,t){if(!Y(e))throw J(`Invalid argument (jpeg_bin), Uint8Array expected`,`EINVAL`);if(typeof t!=`function`)throw J(`Invalid argument (on_segment), Function expected`,`EINVAL`);let n=[],r=0;Z(e,function(e){let i=t(e);if(Y(i))n.push({data:i}),r+=i.length;else if(Array.isArray(i))i.filter(Y).forEach(function(e){n.push({data:e}),r+=e.length});else if(i!==!1){let t={start:e.offset,end:e.offset+e.length};n.length>0&&n[n.length-1].end===t.start?n[n.length-1].end=t.end:n.push(t),r+=e.length}});let i=new Uint8Array(r),a=0;return n.forEach(function(t){let n=t.data||e.subarray(t.start,t.end);i.set(n,a),a+=n.length}),i}function We(e,t){if(!Y(e))throw J(`Invalid argument (jpeg_bin), Uint8Array expected`,`EINVAL`);if(typeof t!=`function`)throw J(`Invalid argument (on_exif_entry), Function expected`,`EINVAL`);Z(e,function(n){if(n.code===218)return!1;if(n.code===225&&n.length>=10&&e[n.offset+4]===69&&e[n.offset+5]===120&&e[n.offset+6]===105&&e[n.offset+7]===102&&e[n.offset+8]===0&&e[n.offset+9]===0)return new He(e,n.offset+10,n.offset+n.length).each(t),!1})}function Ge(e,t){if(!Y(e))throw J(`Invalid argument (jpeg_bin), Uint8Array expected`,`EINVAL`);if(typeof t!=`function`)throw J(`Invalid argument (on_exif_entry), Function expected`,`EINVAL`);let n=!1;return Ue(e,function(r){if(!n&&(r.code===218&&(n=!0),r.code===225&&r.length>=10&&e[r.offset+4]===69&&e[r.offset+5]===120&&e[r.offset+6]===105&&e[r.offset+7]===102&&e[r.offset+8]===0&&e[r.offset+9]===0)){let i=new He(e,r.offset+10,r.offset+r.length).filter(t);if(!i)return!1;let a=new Uint8Array(10);return a.set(e.slice(r.offset,r.offset+10)),a[2]=i.length+8>>>8&255,a[3]=i.length+8&255,n=!0,[a,i]}})}function Ke(e,t){let n=!1,r=0;return Ue(e,function(i){if(r++,r===1&&i.code===216||r===2&&i.code===224||n)return;t=Be(t);let a=new Uint8Array(5+t.length),o=0;return a[o++]=255,a[o++]=254,a[o++]=t.length+3>>>8&255,a[o++]=t.length+3&255,t.split(``).forEach(function(e){a[o++]=e.charCodeAt(0)&255}),a[o++]=0,n=!0,[a,e.subarray(i.offset,i.offset+i.length)]})}function qe(e,t,n,r,i,a,o){try{var s=e[a](o),c=s.value}catch(e){n(e);return}s.done?t(c):Promise.resolve(c).then(r,i)}function Q(e){return function(){var t=this,n=arguments;return new Promise(function(r,i){var a=e.apply(t,n);function o(e){qe(a,r,i,o,s,`next`,e)}function s(e){qe(a,r,i,o,s,`throw`,e)}o(void 0)})}}function Je(e){return Ye.apply(this,arguments)}function Ye(){return Ye=Q(function*(e){let t=yield this._getUint8Array(e.blob);if(e.is_jpeg=X(t),!e.is_jpeg)return e;e.orig_blob=e.blob;try{let n,r;if(We(t,function(t){if(t.ifd===0&&t.tag===274&&Array.isArray(t.value))return e.orientation=t.value[0]||1,n=t.is_big_endian,r=t.data_offset,!1}),r){let i=n?new Uint8Array([0,1]):new Uint8Array([1,0]);e.blob=new Blob([t.slice(0,r),i,t.slice(r+2)],{type:`image/jpeg`})}}catch(e){}return e}),Ye.apply(this,arguments)}function Xe(e){return Ze.apply(this,arguments)}function Ze(){return Ze=Q(function*(e){if(!e.is_jpeg)return e;let t=(e.orientation||1)-1;if(!t)return e;let n;n=t&4?this.pica.createCanvas(e.out_canvas.height,e.out_canvas.width):this.pica.createCanvas(e.out_canvas.width,e.out_canvas.height);let r=n.getContext(`2d`);return r.save(),t&1&&r.transform(-1,0,0,1,n.width,0),t&2&&r.transform(-1,0,0,-1,n.width,n.height),t&4&&r.transform(0,1,1,0,0,0),r.drawImage(e.out_canvas,0,0),r.restore(),e.out_canvas.width=e.out_canvas.height=0,e.out_canvas=n,e}),Ze.apply(this,arguments)}function Qe(e){return $e.apply(this,arguments)}function $e(){return $e=Q(function*(e){if(!e.is_jpeg)return e;let[t,n]=yield Promise.all([this._getUint8Array(e.blob),this._getUint8Array(e.out_blob)]);if(!X(t))return e;let r=[];Z(t,function(e){if(e.code===218)return!1;r.push(e)});let i=r.filter(function(e){return e.code===226?!1:e.code>=224&&e.code<240||e.code===254}).map(function(e){return t.slice(e.offset,e.offset+e.length)});return e.out_blob=new Blob([n.slice(0,2)].concat(i,[n.slice(20)]),{type:`image/jpeg`}),e}),$e.apply(this,arguments)}function et(e){e.before(`_blob_to_image`,Je),e.after(`_transform`,Xe),e.after(`_create_blob`,Qe)}function tt(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),n.push.apply(n,r)}return n}function nt(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]==null?{}:arguments[t];t%2?tt(Object(n),!0).forEach(function(t){q(e,t,n[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):tt(Object(n)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(n,t))})}return e}function rt(e,t){if(e==null)return{};var n={};for(var r in e)if({}.hasOwnProperty.call(e,r)){if(t.includes(r))continue;n[r]=e[r]}return n}function it(e,t){if(e==null)return{};var n,r,i=rt(e,t);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(e);for(r=0;r<a.length;r++)n=a[r],t.includes(n)||{}.propertyIsEnumerable.call(e,n)&&(i[n]=e[n])}return i}var at=[`max`],ot=class{constructor(e){q(this,`pica`,void 0),q(this,`initialized`,void 0),q(this,`_initPromise`,void 0),e=e||{},this.pica=e.pica||Fe({}),this.initialized=!1}use(e,...t){return e(this,...t),this}setup(){this.use(et)}_ensureInitialized(){var e=this;return Q(function*(){return e._initPromise||(e._initPromise=Promise.resolve().then(Q(function*(){e.setup(),yield e.pica.init(),e.initialized=!0}))),e._initPromise})()}toBlob(e,t){var n=this;return Q(function*(){let r={blob:e,opts:nt({max:1/0},t)};return yield n._ensureInitialized(),r=yield n._blob_to_image(r),r=yield n._calculate_size(r),r=yield n._transform(r),r=yield n._cleanup(r),r=yield n._create_blob(r),r.out_canvas.width=r.out_canvas.height=0,r.out_blob})()}toCanvas(e,t){var n=this;return Q(function*(){let r={blob:e,opts:nt({max:1/0},t)};return yield n._ensureInitialized(),r=yield n._blob_to_image(r),r=yield n._calculate_size(r),r=yield n._transform(r),r=yield n._cleanup(r),r.out_canvas})()}before(e,t){var n=this;if(!this[e])throw Error(`Method "`+e+`" does not exist`);if(typeof t!=`function`)throw Error(`Invalid argument "fn", function expected`);let r=this[e];return this[e]=function(){var e=Q(function*(e){let i=yield t.call(n,e);return r.call(n,i)});return function(t){return e.apply(this,arguments)}}(),this}after(e,t){var n=this;if(!this[e])throw Error(`Method "`+e+`" does not exist`);if(typeof t!=`function`)throw Error(`Invalid argument "fn", function expected`);let r=this[e];return this[e]=function(){var e=Q(function*(e){let i=yield r.call(n,e);return t.call(n,i)});return function(t){return e.apply(this,arguments)}}(),this}_blob_to_image(e){let t=window,n=t.URL||t.webkitURL||t.mozURL||t.msURL;return e.image=document.createElement(`img`),e.image_url=n.createObjectURL(e.blob),e.image.src=e.image_url,new Promise(function(t,n){e.image.onerror=function(){n(Error(`ImageBlobReduce: failed to create Image() from blob`))},e.image.onload=function(){t(e)}})}_calculate_size(e){return Q(function*(){let t=e.opts.max/Math.max(e.image.width,e.image.height);return t>1&&(t=1),e.transform_width=Math.max(Math.round(e.image.width*t),1),e.transform_height=Math.max(Math.round(e.image.height*t),1),e.scale_factor=t,e})()}_transform(e){var t=this;return Q(function*(){e.out_canvas=t.pica.createCanvas(e.transform_width,e.transform_height),e.transform_width=null,e.transform_height=null;let n=e.opts,{max:r}=n,i=it(n,at);return yield t.pica.resize(e.image,e.out_canvas,i),e})()}_cleanup(e){return Q(function*(){e.image.src=``,e.image=null;let t=window,n=t.URL||t.webkitURL||t.mozURL||t.msURL;return n.revokeObjectURL&&n.revokeObjectURL(e.image_url),e.image_url=null,e})()}_create_blob(e){var t=this;return Q(function*(){return e.out_blob=yield t.pica.toBlob(e.out_canvas,e.blob.type),e})()}_getUint8Array(e){return Q(function*(){return e.arrayBuffer?new Uint8Array(yield e.arrayBuffer()):new Promise(function(t,n){let r=new FileReader;r.readAsArrayBuffer(e),r.onload=function(){t(new Uint8Array(r.result))},r.onerror=function(){n(Error(`ImageBlobReduce: failed to load data from input blob`)),r.abort()},r.onabort=function(){n(Error(`ImageBlobReduce: failed to load data from input blob (aborted)`))}})})()}};function st(e){return new ot(e)}var $=st;return $.ImageBlobReduce=ot,$.image_traverse=Re,$.pica=Fe,$.Pica=Pe,$});
//# sourceMappingURL=image-blob-reduce.browser.min.js.map